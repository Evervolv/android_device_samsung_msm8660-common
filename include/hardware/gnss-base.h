...
enum {
    ...
    GPS_LOCATION_HAS_MAP_URL = 256, // 0x0100
    GPS_LOCATION_HAS_MAP_INDEX = 512, // 0x0200
};

enum {
    ULP_LOCATION_IS_FROM_HYBRID = 1, // 0x0001
    ULP_LOCATION_IS_FROM_GNSS = 2, //0x0002
};
...
enum {
    AGPS_APN_BEARER_INVALID = -1,
    AGPS_APN_BEARER_IPV4 = 0,
    AGPS_APN_BEARER_IPV6 = 1,
    AGPS_APN_BEARER_IPV4V6 = 2,
};
