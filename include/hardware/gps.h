...
#define LOCATION_HAS_SOURCE_INFO GPS_LOCATION_HAS_VERTICAL_ACCURACY
#define GPS_LOCATION_HAS_IS_INDOOR GPS_LOCATION_HAS_SPEED_ACCURACY
#define GPS_LOCATION_HAS_FLOOR_NUMBER GPS_LOCATION_HAS_BEARING_ACCURACY
